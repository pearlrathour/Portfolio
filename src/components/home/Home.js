...
export default function Home() {
    return (
        <div name="home" className="h-screen w-full ">
            <div className='max-w-screen-lg mx-auto flex flex-col flex flex-col items-center justify-center h-5/6 px-4 md:flex-row'>
                ...
                <div className="flex flex-col justify-center h-full">
                    <h2 className="text-4xl sm:text-7xl font-bold text-white">
                        Lorem ipsum sit voluptatem!
                    </h2>
                    <p className="text-gray-500 text-lg py-10 max-w-md">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium, maxime officia. Deleniti fuga dolore, eveniet dicta rem suscipit ex iste commodi odio sapiente, iusto voluptate nam ut ullam, molestias repellat voluptatem nisi. Ullam veritatis esse non iusto debitis facere sit?
                    </p>
                    ...
                    <div>
                        ...
                        <button type="button" class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
                            <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
                                <path fill-rule="evenodd" d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" clip-rule="evenodd" />
                            </svg>
                            {/* Sign in with Github */}
                        </button>

                        <button type="button" class="text-white bg-[red] hover:bg-[green]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-3xl text-sm px-4 py-4 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
                ...
                <div className="big-screen">
                    <img src={girl} alt="profile" className="rounded-2xl mx-auto w-2/3 md:w-full" />
                </div>
            </div>
        </div>
    )
