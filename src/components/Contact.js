        ...
        <section id="contact" name="contact">
            ...
            <div className='flex justify-center py-6'>
                ...
                <a href="https://leetcode.com/PearlRathour/" target="_blank" rel="noreferrer">
                    <button type="button" className="text-white hover:bg-[#FFA116] rounded-sm p-3 text-center inline-flex items-center mr-3 my-1.5 hover:glow" style={{ '--glow-color': '#FFA116' }}>
                ...
                <a href="https://www.linkedin.com/in/pearlrathour/">
                    <button type="button" class="text-white hover:bg-[#0077b5] rounded-sm p-3 inline-flex items-center text-center mr-3 my-1.5 hover:glow" style={{ '--glow-color': '#0077b5' }}>
                ...
                <a href="mailto:pearl.rathour33@gmail.com">
                    <button type="button" class="text-white hover:bg-[#ea4335] rounded-sm p-3 text-center inline-flex items-center mr-3 my-1.5 hover:glow" style={{ '--glow-color': '#ea4335' }}>
                ...
                <a href="https://github.com/pearlrathour">
                    <button type="button" class="text-white hover:bg-[#333] rounded-sm p-3 text-center inline-flex items-center mr-3 my-1.5 hover:glow" style={{ '--glow-color': 'gray' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.instagram.com/pearlrathour/">
                    <button type="button" class="text-white hover:bg-[#c13584] rounded-sm p-3 text-center inline-flex items-center mr-3 my-1.5 hover:glow" style={{ '--glow-color': '#c13584' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://twitter.com/PearlRathour">
                    <button type="button" class="text-white hover:bg-[#1da1f2] rounded-sm p-3 text-center inline-flex items-center mr-3 my-1.5 hover:glow" style={{ '--glow-color': '#1da1f2' }}>
                ...
                <a href="https://www.codechef.com/users/pearlrathour" target="_blank" rel="noreferrer">
                    <button type="button" className="text-white hover:bg-[#d38334e0] rounded-sm p-3 text-center inline-flex items-center mr-3 my-1.5 hover:glow" style={{ '--glow-color': '#FFA116' }}>
                        <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
